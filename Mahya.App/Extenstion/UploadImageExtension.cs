...
namespace Mahya.App.Extenstion
{
    ...
    {
        public static bool AddImageToServer(this IFormFile image, string fileName, string orginalPath, double? width, double? height, string thumbPath = null, string deletefileName = null)
        {
            if (image != null && image.IsImage())
            {
                ...
                if (!string.IsNullOrEmpty(thumbPath))
                {
                    ...
                    if (width != null && height != null)
                        resizer.ImageResizer(orginalPath + fileName, thumbPath + fileName, (int?) width, (int?) height);
                }
                return true;
